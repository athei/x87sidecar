...
void print_env_help(std::FILE* out) {
    std::fprintf(out,
                 ...
                 "  X87_SAMPLE_HZ=N               rate for the latched thread, default 1000.  The\n"
                 "                                profile records the rate actually achieved as\n"
                 "                                effective_hz.\n"
                 ...
                 "  X87_SAMPLE_REPORT=SECS        profile rewrite interval, default 60.  The file\n"
                 "                                is also written on every catchable exit, so this\n"
