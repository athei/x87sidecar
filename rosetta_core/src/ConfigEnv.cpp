...
void print_env_help(std::FILE* out) {
    std::fprintf(out,
                 ...
                 "                                reads the guest's own PE headers to find the\n"
                 "                                main executable image and follows the thread\n"
                 "                                running it.  Set this only for a target with\n"
                 "                                no PE image, or to profile one library.  If\n"
