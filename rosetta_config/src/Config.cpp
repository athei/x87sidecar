...
static void apply_mask_from_env(const char* env_var, uint64_t& mask, const NameBit* table,
                                int table_len) {
...
RosettaConfig parse_config_from_env() {
    ...
    apply_mask_from_env("ROSETTA_X87_DISABLE_FUSIONS", cfg.disabled_fusions_mask, kFusionBits,
                        kFusionCount);
