...
int main(void) {
    ...
    for (int i = 0; i < 3; i++) {
        ...
        if (g != cases[i].want) {
            printf("FAIL %-8s case %d: got %d want %d\n", "fsin", i, g, cases[i].want);
            fails++;
            break;
        }
    }
